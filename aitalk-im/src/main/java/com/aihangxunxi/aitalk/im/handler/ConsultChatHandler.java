...
public class ConsultChatHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        if (msg instanceof Message && ((Message) msg).getOpCode() == OpCode.MSG_REQUEST) {
            if (ConversationType.CONSULT.ordinal() == ((Message) msg).getMsgRequest().getConversationType().getNumber()) {
                ...
                Message msgAck = msgAssembler.convertConsultMgsHistToMessage(msgHist, ((Message) msg).getSeq());
