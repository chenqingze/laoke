...
public class WebSocketChannelInitializer extends ChannelInitializer<NioSocketChannel> {
	...
	@Resource
	private AccessUserJoinMucHandler accessUserJoinMucHandler;

	@Resource
	private RefuseUserJoinMucHandler refuseUserJoinMucHandler;

	@Resource
	private QueryFansHandler queryFansHandler;

	@Resource
	private WithdrawGroupMsgHandler withdrawGroupMsgHandler;

	@Resource
	private InitMucHistHandler initMucHistHandler;
	...
	@Resource
	private BindUserDeviceHandler bindUserDeviceHandler;

	@Resource
	private ConsultChatHandler consultChatHandler;

	@Resource
	private ConsultReadAckHandler consultReadAckHandler;
