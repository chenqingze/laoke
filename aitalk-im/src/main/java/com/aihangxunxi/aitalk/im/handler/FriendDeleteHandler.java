...
public class FriendDeleteHandler extends ChannelInboundHandlerAdapter {
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
		if (msg instanceof Message && ((Message) msg).getOpCode() == OpCode.FRIEND_DELETE_REQUEST) {
			/*
			 * InvitationRequestRequest firr = ((Message)
			 * msg).getInvitationRequestRequest();
			 *
			 ...
			 * message = invitationAssembler.friendInvitationRequestAck(invitation,
			 * ((Message) msg).getSeq()); ctx.writeAndFlush(message);
			 *
			 * User user =
