...
public class GroupController {
    ...
    public ResponseEntity<ModelMap> queryGroupInvitation(AihangPrincipal aihangPrincipal) {
        ModelMap map = new ModelMap();
        map.put("list", groupService.queryManageGroupInvitation(aihangPrincipal.getUserId()));
        return ResponseEntity.status(HttpStatus.OK).body(map);
