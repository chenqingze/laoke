...
public class GroupController {
    ...
    public ResponseEntity<ModelMap> queryGroupSetting(@RequestParam("groupId") String groupId, AihangPrincipal aihangPrincipal) {
        ModelMap map = new ModelMap();
    ...
    // 修改群内用户昵称
    @PutMapping("/nickname")
    public ResponseEntity<ModelMap> updateUserGroupNickname(@RequestParam("userId") Long userId, @RequestParam("nickname") String nickname) {
        ModelMap map = new ModelMap();
        return ResponseEntity.status(HttpStatus.OK).body(map);
    }
